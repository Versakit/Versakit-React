						...
						2: [
							(o, i, g) => {
								...
								(l.prototype.get = function (n) {
									...
									(l.prototype.isEqual = (n, r) => n === r || (n !== n && r !== r)),
									(i.exports = l);
							},
							{},
						],
...
`)),
      ...
      `);
			...
			fe = (0, H.default)(10)((e, t, s) => {
				const o = e.map(({ name: i, value: g }) => ee(null, i, g, !0, s, g === t));
		...
		M.register(X, () => {
			M.add(X, {
				...
				render: () =>
					v.createElement(w, null, v.createElement(me, null), v.createElement(pe, null)),
			});
		});
	})();
} catch (e) {
