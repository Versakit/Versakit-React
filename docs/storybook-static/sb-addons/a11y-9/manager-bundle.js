try {
	(() => {
		...
		var x = "storybook/a11y",
				...
				e
					? e === "blurred vision"
						...
						: e === "grayscale"
							...
							: `url('#${e}')`
					: "none",
			st = c.div(() => ({ "&, & svg": { position: "absolute", width: 0, height: 0 } })),
			ut = c.span(
				{
					background:
			...
			pt = c.span(({ theme: e }) => ({ fontSize: 11, color: e.textMutedColor })),
			gt = (e, r) => [
				...(e !== null
					? [
							{
					...
					: []),
				...ct.map((n) => {
					const t = n.percentage !== void 0 ? `${n.percentage}% of users` : void 0;
					return {
						id: n.name,
			...
			ht = () => {
				...
				return a.createElement(
					a.Fragment,
					null,
					e && a.createElement(Oe, { styles: { [`#${lt}`]: { filter: Ge(e.name) } } }),
					a.createElement(
						Se,
						{
							placement: "top",
			...
			Rt = c.a({ marginTop: 12, textDecoration: "underline", color: "inherit", display: "block" }),
			bt = ({ item: e }) =>
				a.createElement(
					Et,
					null,
					a.createElement(ft, null, e.description),
					a.createElement(Rt, { href: e.helpUrl, target: "_blank" }, "More info..."),
				),
			re = (e, r) => (
				(re =
		...
		function Jt(e) {
			return e == null ? (e === void 0 ? Qt : qt) : He && He in Object(e) ? Kt(e) : Xt(e);
		}
		var Zt = Jt;
		function er(e) {
		...
		function Sr(e, r, n) {
			...
			return (
				_r(n) && ((t = "leading" in n ? !!n.leading : t), (o = "trailing" in n ? !!n.trailing : o)),
		...
		var Or = Sr,
			...
			ze = (e, r, n, t) => (o) => {
				var u = o.width,
					s = o.height;
				r((l) =>
					(l.width === u && l.height === s) || (l.width === u && !t) || (l.height === s && !n)
						? l
			...
			function r(n) {
				...
				(t.cancelHandler = () => {
					...
					(t.getElement = () => {
						...
						if (g && Be(g)) return g;
						if (t.targetRef && Be(t.targetRef.current)) return t.targetRef.current;
						var i = ve(t);
						if (!i) return null;
		...
		var xr = c.div({
			...
			Hr = [Y(z.light).color.negative, Y(z.light).color.positive, Y(z.light).color.warning],
			Ke = ue({
			...
			ie = () => pe(Ke),
			Lr = c.input(({ disabled: e }) => ({ cursor: e ? "not-allowed" : "pointer" }));
		function $e(e, r) {
			const n = e.filter((t) => r.includes(t.target[0])).length;
			return n === 0 ? 1 : n === e.length ? 0 : 2;
		}
		var Pr = ({ toggleId: e, elementsToHighlight: r = [] }) => {
				const { toggleHighlight: n, highlighted: t } = ie(),
					o = a.useRef(null),
			...
			Vr = c.div(({ theme: e }) => ({
				...
				width: "100%",
				"&:focus": { outline: "0 none", borderLeft: `3px solid ${e.color.secondary}` },
			})),
			Kr = c.span({
				fontWeight: "normal",
				float: "right",
				...
				return a.createElement(
					...
					r
						? a.createElement(
								...
								a.createElement(Wr, { elements: t.nodes, type: o, key: "elements" }),
			...
			te = ({ items: e, empty: r, type: n }) =>
				a.createElement(
					...
					null,
					e && e.length
						? e.map((t) => a.createElement(Xr, { item: t, key: `${n}:${t.id}`, type: n }))
			...
			Zr = c.button(
				({ theme: e }) => ({
					...
					"&:focus": { outline: "0 none", borderBottom: `3px solid ${e.color.secondary}` },
				}),
				({ active: e, theme: r }) =>
		...
		var nn = ({ tabs: e }) => {
				const { ref: r, width: n } = Ve({
					...
					u = v(
						(m) => {
							o(Number.parseInt(m.currentTarget.getAttribute("data-index") || "", 10));
						},
						[o],
					),
				...
				return h(
					...
					h(
						...
						h(
							...
							null,
							e.map((m, p) =>
								h(Zr, { key: p, "data-index": p, active: t === p, onClick: u }, m.label),
							),
						),
					),
					e[t].items.length > 0
			...
			an = c(Xe)(({ theme: e }) => ({ animation: `${e.animation.rotate360} 1s linear infinite;` })),
			...
			sn = () => {
				const { manual: e } = he("a11y", { manual: !1 }),
				...
				const m = (f) => {
					...
					_ = W(() => {
						const { passes: f, incomplete: R, violations: T } = s;
						return [
							{
