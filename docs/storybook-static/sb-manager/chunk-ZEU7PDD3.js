...
var __esm = (fn, res) => () => (fn && (res = (0, fn[__getOwnPropNames(fn)[0]])((fn = 0))), res);
	...
	"../../node_modules/memoizerific/memoizerific.js"(exports, module) {
		(function (f) {
			...
			return (function e(t, n, r) {
				...
				{
					1: [
						(_dereq_, module3, exports3) => {
							module3.exports = (forceSimilar) => {
					...
					2: [
						(_dereq_, module3, exports3) => {
							...
							(Similar.prototype.get = function (key) {
								...
								(Similar.prototype.isEqual = (val1, val2) =>
